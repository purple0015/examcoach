...
export function NavBar() {
  ...
  return (
    <header className="sticky top-0 z-40 border-b border-surface-border bg-surface-light/85 backdrop-blur dark:border-slate-800 dark:bg-slate-950/85">
              ...
              <Link
                ...
                className={cn(
                  ...
                  pathname === href || pathname.startsWith(`${href}/`)
                    ...
                    : "text-brand-text-primary hover:bg-surface-canvas dark:text-slate-300 dark:hover:bg-slate-800"
                )}
              >
      ...
      {open && (
        <div className="border-t border-surface-border px-4 py-3 md:hidden dark:border-slate-800">
            ...
            {session &&
              links.map(({ href, label, icon: Icon }) => (
                <Link
                  ...
                  className="flex items-center gap-2 rounded-lg px-3 py-2 text-sm font-medium text-brand-text-primary hover:bg-surface-canvas dark:text-slate-200 dark:hover:bg-slate-800"
                >
                  <Icon className="h-4 w-4" aria-hidden />
                  {label}
                </Link>
