    ...
    <AppShell width="narrow">
      ...
      <section className="card mt-6">
        ...
        <div className="mt-4">
          ...
          <p className="text-xs text-stone-500 dark:text-stone-400">{t.settings.languageDesc}</p>
          <div className="mt-3">
        ...
        <div className="mt-6">
          ...
          <p className="text-xs text-stone-500 dark:text-stone-400">{t.settings.themeDesc}</p>
          <div className="mt-3">
