  ...
  return (
    <AppShell>
      <header className="mb-8 text-center">
        ...
        <p className="mt-4 mx-auto max-w-2xl text-stone-500 dark:text-stone-400">
          {t.pricing.subtitle}
        </p>
            ...
            <button
              ...
              className={`rounded-lg px-6 py-2 text-sm font-medium transition-all ${
                region === "international"
                  ? "bg-white text-primary-600 shadow-sm dark:bg-stone-700 dark:text-primary-400"
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {PLANS.map((plan) => {
          ...
          return (
            <article
              key={plan.id}
              className={`relative flex flex-col rounded-2xl border bg-white p-6 shadow-sm transition-all hover:shadow-md dark:border-stone-800 dark:bg-stone-900 ${
                isCurrent ? "ring-2 ring-primary-500 ring-offset-2 dark:ring-offset-stone-950" : "border-stone-200"
              }`}
            >
              {isTrial && (
                <span className="absolute -top-3 left-1/2 -translate-x-1/2 rounded-full bg-orange-600 px-3 py-1 text-xs font-medium text-white shadow-sm">
                  Recommended
                </span>
              )}
              ...
              <div className="mb-6">
                ...
                {plan.price > 0 && <span className="ml-1 text-sm text-stone-500">{t.common.perMonth}</span>}
                {isTrial && <span className="ml-1 text-sm text-stone-500">for 7 days</span>}
              </div>

              <div className="mb-6 flex-1">
                <p className="mb-4 text-sm font-medium text-stone-900 dark:text-stone-100">Key Features:</p>
                <ul className="space-y-3">
                  ...
                  {plan.maxSeats > 1 ? (
                    ...
                    <FeatureItem text={`${plan.maxSeats} Seat`} icon={<Users className="h-4 w-4 text-stone-400" />} />
                  )}
              ...
              <button
                ...
                className={`mt-auto w-full rounded-xl py-3 text-sm font-semibold transition-colors ${
                  isCurrent 
                    ? "bg-stone-100 text-stone-400 cursor-default dark:bg-stone-800" 
                    : isTrial || plan.price > 20
                      ? "bg-primary-600 text-white hover:bg-primary-700 shadow-sm shadow-primary-200 dark:shadow-none"
                      : "bg-white border border-stone-200 text-stone-700 hover:bg-stone-50 dark:bg-stone-800 dark:border-stone-700 dark:text-stone-200"
                }`}
              >
      ...
      <section className="mt-20 rounded-3xl bg-stone-50 p-8 dark:bg-stone-900/50">
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-stone-500">Unlock all 14 study methods including Feynman Coaching and Mock Exams.</p>
            </div>
          </div>
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-stone-500">Get priority access to Groq LPU processing for instant AI responses.</p>
            </div>
          </div>
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-stone-500">Study in Swahili, Arabic, Mandarin, and more with full AI support.</p>
            </div>
          </div>
          <div className="flex gap-4">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg bg-orange-100 text-orange-600 dark:bg-orange-900/30 dark:text-orange-400">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-stone-500">Higher tiers allow multiple seats for families, classes, or NGOs.</p>
            </div>
          </div>
          <div className="flex gap-4">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-stone-500">Practice with real exam formats and get detailed AI feedback.</p>
            </div>
          </div>
        </div>
      </section>
